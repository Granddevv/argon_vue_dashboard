                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Download Vue Component</h6>
                                    <p class="description mt-3">This is a great free UI package based on Bootstrap 4
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <p class="description mt-3">This is a great free UI package based on Bootstrap
                    ...
                    <div class="p-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 ml-lg-auto">
                                <base-button tag="a" href="https://github.com/granddevv"
