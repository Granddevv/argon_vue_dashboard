<template>
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            <a slot="brand" class="navbar-brand mr-lg-5" href="https://github.com/granddevv">
                <img src="https://avatars3.githubusercontent.com/u/31965726?s=460&v=4" style="border-radius: 10px;">
                <span style="color: white; margin-left: 10px">Grand Dev</span>
            </a>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">Let's go</span>
                    </a>
                    <div class="dropdown-menu-inner">
                        <a href="https://github.com/granddevv"
                        ...
                        <a href="https://github.com/granddevv"
                           class="media d-flex align-items-center">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="description d-none d-md-inline-block mb-0">Learn how to use this
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/Granddevv"
